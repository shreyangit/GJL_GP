...
public class BrightnessZombieAI : MonoBehaviour
{
    ...
    public float brightnessRadius = 3f;
    ...
    void Start()
    {
        ...
        Debug.Log($"{gameObject.name} brightness zombie AI initialized");
    }
    ...
    void UpdateMovement()
    {
        ...
        {
            // Move towards player (slower than normal zombies)
    ...
    void OnDrawGizmosSelected()
    {
        ...
        // Draw brightness effect range
        Gizmos.color = brightnessColor;
        Gizmos.DrawWireSphere(transform.position, brightnessRadius);
